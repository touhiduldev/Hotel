            ...
            <div class="auto-container">
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <figure class="image-box"><a href="{{ asset('uploads/product/' . $all_product->first()->image) }}"
                                class="lightbox-image" data-fancybox="gallery"><img
                                    src="{{ asset('uploads/product/' . $all_product->first()->image) }}" alt=""></a>
                        </figure>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div class="content-box">
                            <h2>{{ $all_product->first()->title }}</h2>
                            <h4>${{ $all_product->first()->after_discount }}</h4>
                            ...
                            <div class="text">
                                <p>{!! $all_product->first()->short_desp !!}</p>
                            </div>
                            <div class="addto-cart-box p_relative d_block mb_35">
                                <ul class="clearfix">
                                    <form action="{{ route('add.cart') }}" method="POST">
                                        ...
                                        <input type="hidden" name="product_id" value="{{ $all_product->first()->id }}"
                                            id="">
                ...
                <div class="tabs-box">
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab" id="tab-1">
                            <div class="content-box">
                                <p class="mb_25">{!! $all_product->first()->long_desp !!}</p>
                            </div>
                        </div>
